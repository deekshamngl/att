			  ...
			  <form action="<?php echo $paypalUrl; ?>" method="post" name="frmPayPal1">
					<div class="panel price panel-red">
						...
						<div class="panel-footer">
							<button  href="#"><img class="img-rounded" src="../assets/img/secure_payment_by_paypal.jpg" style="max-width:100px; "/></button>
						</div>
					</div>
    			</form>
			<!-- /PRICE ITEM -->
				...
				<form action="<?php echo $action; ?>" method="post" name="payuForm" id="submit_payumoney" >
				  ...
				  <table>
					...
					<tr hidden>
					  ...
					  <td><input name="amount" type="number" id="payumoney_amount" /></td>
...
var user = $('#users').val();	
	...
	$('#payumoney_amount').val(paymentInRs); 		
	$('#payumoney1').show();
