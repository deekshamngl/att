            ...
            <div class="col-md-12" >
              <div class="card valign">
                <div class="card-header" data-background-color="orange">
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      <h6 class="nav-tabs-title">My Addons </h6>
                    </div>
                  </div>
                </div>
				...
				<!----Start Tab for Addons---->
                    ...
                    <td width="20%" align="right"><input type='checkbox'  name="location_tracecheck" id="location_tracecheck"/></td>
                    </tr>
					...
					<tr>
                    <td width="24%" align="left">Plan Amount /User<span id="_per"></td>
                    <td width="1%"></td>
					...
					<tr>
                    <td width="24%" align="left">Plan Amount</td>
                    <td width="1%"></td>
	...
	var totalcart=0;
       ...
       switch (true) {
			  ...
			  var cur='';		
				...
				var plan_m_y="/month";
				if(plan=='YEARLY'){
					bulkperprice=bulkperprice*10;
					visitperprice=visitperprice*10;
					timeoffperprice=timeoffperprice*10;
					payrollperprice=payrollperprice*10;
					loctraceperprice=loctraceperprice*10;
					geofenceperprice=geofenceperprice*10;
					plan_m_y="/year";
				}
				...
				$('#payroll_perprice').text("Payroll @"+cur+" "+payrollperprice+plan_m_y);
		...
		var string = "";	
			...
			var paypal_email = 'namrata@ubitechsolutions.com';
