                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header" data-background-color="green">
                      <p class="category" style="color:#ffffff;font-size:17px;"  >Add geo center</p>
                    </div>
				  ...
				  <div class="col-md-5" style="padding-left:30px;" >
					...
					<!--  <div class="row" >
					  ...
					  <div class="row" >
						   ...
						   <div class="col-sm-8" >
                          <textarea  rows="3" cols="50" class="form-control" id="location" name="location" placeholder="Eg. Rajiv Chowk, Rajeev Chowk, Connaught Place, New Delhi, Delhi 110001, India" disabled > </textarea>
