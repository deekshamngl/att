	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="green">
	                                ...
	                                <p class="category">Department Wise Report</p>
								...
								<div class="row">
									...
									<thead>
										...
										<tr style="background-color:#68d46d;color:#ffffff;">												
													...
													<th width="8%" >Late By</th>
													<th width="9%" >Time Out</th>
													<th width="10%" >Early By</th>
													<th width="12%" >Overtime/Undertime </th>
													<th width="8%"  >Time Off </th>				
													<th  width="12%">Total Working Hours</th>
													<th>Department</th>
	...
	<script type="text/javascript">
    	...
    	$(document).ready(function() { 
			...
			var table= $('#example').DataTable( {
				...
				"ajax": "<?php echo URL;?>Admin/getDeparmentReport",
				"columnDefs": [
			...
			////---------date picker
			var minDate = moment();
			var start = moment().subtract(7, 'd');
			var end = moment().subtract(1, 'd');
...
////---------/date picker
	//	$('#reportrange').on('DOMNodeInserted',function(){ //
		$('#getAtt').click(function(){ 
			...
			$('#example').DataTable( {
					// "aTargets": [ 1 ], "order": [[1, 'asc']], "bSortable": true,
					//"scrollX": true,
					"order": [[ 10, "desc" ]],
					 dom: 'Bfrtip',
					 	 "bSort": true,
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>Admin/getDeparmentReport?date="+range+"&shift="+shift+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": 10}
