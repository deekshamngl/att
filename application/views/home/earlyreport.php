              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                   <p class="category" style="color:#ffffff;font-size:17px;" > Early Leavers</p>
                   ...
                   <div class="card-content">
							 ...
							 </div><!--	<a rel="tooltip" onclick="openNav()"  rel="tooltip"  data-placement="bottom" title="Help" class="btn btn-success btn-sm pull-right ">	-->
				 <div id="typography">
						<div class="title">
								<div class="row">
									<div class="col-md-4">
   ...
   <script type="text/javascript">
    	...
    	$(document).ready(function() {
			...
			"paging": true,
				...
				"ajax": "<?php echo URL;?>admin/getearlyleave__new?datestatus="+7,
				"columnDefs": 
				[
	...
	//	$('#reportrange').on('DOMNodeInserted',function(){ //alert();
		$('#getAtt').click(function(){
			...
			$('#example').DataTable( {
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>admin/getearlyleave__new?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": [1,2,8] }
				],
					"columns": [
