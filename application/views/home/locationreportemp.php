              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                   <p class="category" style="color:#ffffff;font-size:17px;" >Employees Wise</p>
		...
		var ss;
			var table= $('#example').DataTable({
		       ...
		       buttons: [
						...
						'pageLength','csv','excel','copy','colvis',
            ...
            repeatingHead:{
               ...
               logoPosition: 'center',
                ...
                title: 'Punch Visit Report of '+org+' Dated '+isoDateString+'',
            ...
            customize: function (win) {
				...
				"ajax": "<?php echo URL;?>admin/punchedLocations",
				"columnDefs": [
		...
		$('#getAtt').click(function(){
            ...
            customize: function (win) {
                ...
                $(win.document.body).find('table')
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>admin/punchedLocations?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": [1,0]},
