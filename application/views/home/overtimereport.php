...
<head>
  ...
  <title>List of employee(s)</title>
     <style>
    	...
    	$(document).ready(function() {
			...
			var table= $('#example').DataTable( {
		       ...
		       buttons: [
				...
				"ajax": "<?php echo URL;?>admin/overTimeR",
				"columnDefs": [
		...
		$('#getAtt').click(function(){
			...
			$('#example').DataTable( {
				 ...
				 //'colvis'   "+range+"&shift="+shift+"&deprt="+deprt,
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>admin/overTimeR?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": [1,2] }
				],
