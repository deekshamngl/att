   ...
   <script type="text/javascript">
    	...
    	$(document).ready(function() {
			...
			var table= $('#example').DataTable( {
				...
				"ajax": "<?php echo URL;?>admin/Timeoffreport",
				"columnDefs": [
	...
	//	$('#reportrange').on('DOMNodeInserted',function(){ //alert();
		$('#getAtt').click(function(){
			...
			$('#example').DataTable( {
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>admin/Timeoffreport?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": [1,2,3,4,5] }
				],
					"columns": [
