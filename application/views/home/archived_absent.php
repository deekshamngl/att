	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			?>
			  ...
			  <section class="content" id="printsection" style="margin-top:45px;" >
			<div class="content"  >
	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="green">
	                                <p class="category" style="color:#ffffff;font-size:17px;" >Absent Employees</p>
								</div>
			...
			<footer class="footer">
				<div class="container-fluid">
					...
					<!--<p class="copyright pull-right" style="padding-right:30px;" >
	...
	<script type="text/javascript">
    	...
    	//$(document).ready(function() {
			var table= $('#example').DataTable( {
				...
				"ajax": "<?php echo URL;?>admin/getAbsent__archive?datestatus="+7,
...
////---------/date picker
	...
	$('#getAtt').click(function(){
			...
			$('#example').DataTable({
					...
					"contentType": "application/json",
					//"ajax": "<?php echo URL;?>admin/getAbsent?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"ajax": "<?php echo URL;?>admin/getAbsent__archive?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": [1,3,6] }
				],
					"columns": [
