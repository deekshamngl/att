        ...
        <div class="content" id="content" style="" >
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                    <p class="category" style="color:#ffffff;font-size:17px;" >  Present Employees </p>
              ...
              <div class="row" >
              <select id="county" style="height:35px;position:relative;" class="col-sm-11">
...
<script type="text/javascript">
  ...
  columnDefs: [ { orderable: false, targets: [15,16]}],
    ...
    "ajax": "<?php echo URL;?>admin/getAttendances__new?datestatus="+7+datestring,
    "columnDefs": 
  [
  ...
  //columnDefs: [ { orderable: false, targets: [14,15]}],
    ...
    "contentType": "application/json",
    "ajax": "<?php echo URL;?>admin/getAttendances__new?date="+range+"&shift="+shift+"&dept="+dept+"&empl="+empl+"&desg="+desg+"&county="+county,
    "columnDefs": [
          { "visible": false, "targets": [1,2,4,5,9,14] }
          ],
    "columns": [
