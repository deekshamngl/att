...
<body>
	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="green">
	                                <h4 class="title">Import Departments</h4>
	                                <p class="category"> </p>
	                        </div>
  ...
  <div class="card-content">
	...
	<div class="panel panel-default" id="login-form" style="display:block">
      <div class="panel-heading">Import Departments</div>
		...
		<form id="upload_csv" method="post" enctype="multipart/form-data">
				...
				<div class="box box-solid" style="background-color:#EFEFF8;padding:10px">
					<div class="box-header with-border">
						...
						<div class="box-body">
                            ...
                            <li>There should be no duplicate Department.</li>
		    ...
		    <div class="col-md-12">
				...
				<div class="col-sm-6">
					...
					<a href="<?php echo IMGURL;?>newdepartment.csv" >Download sample file</a>
				</div>
			</div>
			...
			<div class="col-sm-12" >
               ...
               <input type="button" class="btn btn-success" value="Close" onclick="window.location='<?= URL?>admin/departments'">
			   </center>
          </div>
    	</form>
    </div>
...
<script>
  ...
  $.ajax({
    url: "<?php echo URL;?>admin/importUploadsDep",
    method:"POST", 
