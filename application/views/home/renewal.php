...
<!------------------------------------------End Old Code------------------------------------------------->
	 ...
	 <!-------Addons tab close----------->
            ...
            $remainingdays = $myplan['days']; 

            
           ?>

						<td>Additional Users for <?php echo $remainingdays ; ?> days</td>
                ...
                <?php 
                    ...
                    <input type="text"  id="gstin" class="form-control descrip" name="gstin" value='' pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" placeholder="GST No." />
                    </div>
                    </div>
...
/* 								}); */
  ...
  function checkBillingForm(){
        ...
        // if($("#gstin").val()!="/^(0[1-9]|[1-2][0-9]|3[0-5])([a-zA-Z]){5}([0-9]){4}([a-zA-Z]){1}([a-zA-Z0-9]){1}([a-zA-Z]){1}([0-9]){1}?$/"){

        //   $("#gstin").focus();
        //   alert('Please enter correct gst no. ');
        //   return false;
        // }
 ...
 $(document).ready(function () {
	...
	$("#continue6").click(function(){
      ...
      $(".noOfUser_12").text(users);  // user lim updated by(users)
        ...
        // }
        if(plan=='YEARLY' && extendday < 306 ){
          amount= price/12*($("#duration").val());
        }
       else{
        amount =  price*($("#duration").val());
       }
