										...
										<!--<h3 class="text-center">   Employee Late Report</h3>-->
											...
											<thead>
												...
												<tr style="background-color:#68d46d;color:#ffffff;">
													...
													<th width="10%" class="text-left">Absent</th>
													<th width="10%" class="text-left">Late By</th>
													<th width="10%" class="text-left">Early By</th>
													<th width="10%" class="text-left">Overtime/ Undertime </th>
													<th width="10%"  class="text-left">Time Off </th>									
	...
	<script type="text/javascript">
    	...
    	$(document).ready(function() {
			...
			var table= $('#example').DataTable( {
				...
				"ajax": "<?php echo URL;?>admin/getEmployeeSummaryReport",
				"columnDefs": [
	...
	//	$('#reportrange').on('DOMNodeInserted',function(){ //
		$('#getAtt').click(function(){ 
			...
			$('#example').DataTable( {
					...
					"contentType": "application/json",
					"ajax": "<?php echo URL;?>admin/getEmployeeSummaryReport?date="+range+"&shift="+shift+"&deprt="+deprt+"&empl="+empl+"&desg="+desg,
					"columnDefs": [
					{ "visible": false, "targets": 1 }
				],
					"columns": [
