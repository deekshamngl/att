              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <!--  <h4 class="title">Attendance</h4> -->
                   <p class="category" style="color:#ffffff;font-size:17px;" > List of employees</p>
											...
											<thead>
												<tr style="background-color:#008067;color:#ffffff;">
													...
													<!--<th>Visited Client</th>-->
													 ...
													 <th>Time In Date</th>
													<th >Time In</th>
													<th width="15%">Location In</th>
													<th>Visit Out</th>
													<th>Time Out Date</th>
													<th >Time Out</th>
												<!--	<th >Total Time</th> -->
													<th width="15%">Location Out</th>
													<th>Logged Hours</th>
													<th >Action</th>
												</tr>
											</thead>
    	...
    	$(document).ready(function(){
			...
			var table= $('#example').DataTable({
		       ...
		       buttons: [
				...
				"ajax": "<?php echo URL;?>admin/punchedFlexi",
				"columnDefs": [
