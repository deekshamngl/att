...
<html>
  <head>
    <meta charset="UTF-8">
    <title>UBIHRM |  Leave Approval</title>
 ...
 <!-- Ionicons -------->
  ...
  <body class="skin-green"  ng-app="leaveapi"  ng-controller="leaveapprovalbymailCtrl" ng-init=" onfetch(userid,org_id,employeeleaveid,approverresult,appSts); ">
    <!-- Site wrapper -->
  <h1 class="text-center" ng-show="appleaveSts!=5">{{result}}</h1>
  <div class="overlay text-center" ng-show="hastrue">
                  <h1><i class="fa fa-refresh fa-spin"></i></h1>
                </div>
    <div  ng-show="appleaveSts==5" class="overlay text-center" >
                  <h1>Leave has already withdrawn</h1>
                </div>
  <div ng-show="appleaveSts == 3" class="modal fade" id="comment" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
