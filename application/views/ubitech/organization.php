					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">All Organizations</h4>
							...
							<div id="typography">
								<div class="title">
									...
									<div class="col-sm-3 text-right">
													<button class="btn btn-sm btn-primary" data-toggle="modal"  type="button"	onclick="Allassign();"><i class="fa fa-plus"> Assign Lead Owner</i>
													</button>	
									</div>
											<div class="col-sm-3 text-right">
												<button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addSld" type="button" style="margin-left: -20px;">	
	...
	<script type="text/javascript">
		...
		$(function()
		{
			 table=$('#example').DataTable({
        				...
        				// },
        			'columnDefs': [
       					{ targets: [11,10,9,13,14], visible :false }
    					],
			...
			$("#getAtt").click(function() {
		      ...
		      table=$('#example').DataTable({
        				...
        				// },
        			'columnDefs': [
       					{ targets: [9,11,10,13,14], visible :false }
    					],
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/getOrganizationData?conttype="+conttype+"&date="+range,
						"columns": [
							{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
