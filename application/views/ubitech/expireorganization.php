					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Expired Trial-Complete List</h4>
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/expireOrganizationData",
						"columns": [
							{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/expireOrganizationData?conttype="+conttype+"&date="+range,
						"columns": [
						{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
