					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Paid Users - Standard</h4>
									...
									<div class="col-sm-2" style="margin-top:-20px;">
											<select id="getval" class="form-control">
					                         ...
					                         <div class="col-sm-2 text-right">
												...
												<!--<div class="col-sm-1" style="margin:7px;margin-right:10px">
													<button class="btn btn-sm btn-primary" data-toggle="modal"  type="button" onclick="archiveall();">	
														<i class="fa fa-envelope"> Archive</i>
													</button>
												</div>-->
											</div>
										</div>
										<div class="row">
											...
											<thead>
												<tr>
													...
													<th>Country</th>
													<th>City</th>
													<th width="85">Plan Start</th>
													
													<th width="85">Plan End</th>
													<th>Lead Owner</th>
													<th>Rating</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">		
		<form>
			<div class="row">
				<div class="col-md-12">
					<h4>Archive the Company data?</h4>
				</div>
			</div>
			<div class="clearfix"></div>
		</form>
      ...
      <div class="modal-footer">
        <button type="button" id="deleteall"  class="btn btn-danger">Archive</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
    </div> 
  </div> 
...
function archiveall(){
	...
	{
		doNotify('top','center',3,'select atleast 1 employee to archive');
		return false;
	}
}
	$(document).on("click", "#deleteall", function (e)
				{
				$.ajax({url: "<?php echo URL;?>ubitech/archiveAllOrg",
	...
	<script type="text/javascript">
		...
		//$(function(){
			 ...
			 table=$('#example').DataTable( {
						...
						'columnDefs':
						[
       					{ targets: [9,10,11,14,13], visible :false }
    					],
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/paidgetOrganizationData",
						"columns":[
							{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
						...
						if(parseInt(data.noemp) > parseInt(data.userlimit)){
							$(row).addClass('red');
						}
                      }
					});
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/paidgetOrganizationData?conttype="+conttype,
						"columns": [
							{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
