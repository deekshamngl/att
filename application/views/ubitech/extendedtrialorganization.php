					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Extended Trial</h4>
		...
		$(function(){
			// alert('true');
			 table=$('#example').DataTable( {
						...
						// "stateDuration": 10,
						'columnDefs': [
       					{ targets: [12,11,9,10,8], visible :false }
    					],
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/extendTrialOrganizationData",
						"columns": [
						{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/extendTrialOrganizationData?conttype="+conttype,
						"columns": [
						{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
