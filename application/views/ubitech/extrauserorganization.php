					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Exceeded User Limit</h4>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form id="deptFrom" action="<?php echo URL;?>ubitech/"  >
			<div class="row">
				<div class="col-md-12">
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/getExtrauserOrg",
						"columns": [
							{ "data": "orgname"},
    ...
    var table=$('#example').DataTable( {
					...
					// "lengthMenu": [[10, 25, 50,100,500,1000,-1],[10,25,50,100,500,1000,"All"]],
						...
						// "stateDuration": 10,
						// 'columnDefs': [
      //  					{ targets: [12,11,7,8,13], visible :false }
    		// 			],
						buttons: [
					'pageLength','csv', 'excel','copy','print',
					{ 
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/getExtrauserOrg?conttype="+conttype,
	...
	/*	$.ajax({url:"<?php echo URL;?>ubitech/getOrganizationData",
		type: 'POST',
