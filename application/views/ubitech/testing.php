										...
										<div class="title">
											<div class="row">
												<div class="col-sm-10 text-right">
													<button class="btn btn-sm btn-primary" data-toggle="modal"  type="button"	onclick="Alldelete();" style="margin-top:35px"><i class="fa fa-trash"> Delete</i>
													</button>	
												</div>
