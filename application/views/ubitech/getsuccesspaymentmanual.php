					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Transaction History <?php echo $orgid!=0?'for <b>'.getOrgName($orgid).'</b>':'- Manual Payments';?></h4>
			 ...
			 table=$('#example').DataTable( {
					...
					{ 
                     ...
                     "columns":':not(:last-child)', 
						...
						"ajax": "<?php echo URL;?>ubitech/getSuccessfulPaymentData/manual",
						"columns": [
							{ "data": "date" },
							{ "data": "company" },
							{ "data": "activity" },
