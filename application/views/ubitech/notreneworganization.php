					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Not to be Renewed</h4>
...
<div id="renew" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><i class="material-icons">close</i></button>
        <h4 class="modal-title" id="title">Undo Not Renew</h4>
      </div>
      <div class="modal-body">		
		<form>
			...
			<div class="row">
				<div class="col-md-12">
					<h4>Are you sure that Undo Not Renew?"<span id="dna1"></span>" ?</h4>
				</div>
			</div>
			<div class="clearfix"></div>
		</form>
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/notRenewOrganizationData",
						"columns": [
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/notRenewOrganizationData?conttype="+conttype,
						"columns": [
							{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
		...
		$(document).on("click", "#notrenewed", function () {
				var id=$('#del_did1').val();
				$.ajax({url: "<?php echo URL;?>ubitech/renedOrg",
						data: {"did":id},
						success: function(result){
							result=JSON.parse(result);
							if(result.afft){
								$('#notrenewed').modal('hide');
								doNotify('top','center',2,'Company Undo Not Renew  successfully.');
								$('#renew').modal('hide');
								var table=$('#example').DataTable();
								 table.ajax.reload();
							}else{
								$('#renew').modal('hide');
								doNotify('top','center',4,'Unable to renew this company');
							}
