						 ...
						 ?>
	                		...
	                		<div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Manual Notifications</h4>
										...
										<div class="title">
											<div class="row">
												...
												<div class="col-sm-3 text-right">
													<button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addnot" type="button">	
		...
		<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group ">
					 ...
					 <div class="form-group ">
						<label class="control-label">Date<span class="red"> *</span></label>
						<input type="date" id="dosE" name="dosE" class="form-control" min="<?php echo $today ?>">
					</div>
			...
			// $("#example").dataTable().fnClearTable();
			 table=$('#example').DataTable({
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/getconfiguredata",
						"columns": [
		...
		$('#saveE').click(function(){
			...
			formdata.append('id',id);
				   ...
				   $.ajax({
					   processData: false,
					contentType: false,
					url: "<?php echo URL;?>ubitech/editnotification",
