					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Transaction History <?php echo $orgid!=0?'for <b>'.getOrgName($orgid).'</b>':'- Failed Transaction';?></h4>
			 ...
			 table=$('#example').DataTable( {
					...
					{ 
                     ...
                     "columns":':not(:last-child)', 
						...
						"ajax": "<?php echo URL;?>ubitech/getPaymentFailedHistoryData/"+orgid,
						"columns": [
							{ "data": "date" },
							{ "data": "company" },
							{ "data": "activity" },
