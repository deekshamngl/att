					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Paid Users - Customized</h4>
	                                <p class="category">Customized Organization Settings</p>
	                            </div>
	                            <div class="card-content">
									...
									<div class="col-sm-3">
													<button class="btn btn-sm btn-primary" data-toggle="modal"  type="button"	onclick="Allassign();" style="margin-top:10px"><i class="fa fa-plus"> Assign Lead Owner</i>
													</button>	
												</div>
	...
	<script type="text/javascript">
		...
		$(function(){
			 table=$('#example').DataTable( {
        				...
        				'columnDefs': [
       					{ targets: [9,10,11,13,14], visible :false }
    					],
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/customizedOrganizationData",
						"columns": [
						{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
...
,
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/customizedOrganizationData?conttype="+conttype,
						"columns": [
						{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
