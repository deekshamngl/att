					   	...
					   	<!-- this message for success or error end-->
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Trial Organizations</h4>
		...
		$(function()
		{
			...
			// $("#example").dataTable().fnClearTable();
			 table=$('#example').DataTable({
        				...
        				//},
        			'columnDefs': [
       					{ targets: [12,11,9,10,13,16], visible :false },
    					],
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/trialgetOrganizationData",
						"columns": [
						{ "data": "change"},
							{ "data": "orgName"},
							{ "data": "c_nmae" },
			...
			$("#example").dataTable().fnDestroy();
			 table=$('#example').DataTable( {
                ...
                customize: function (doc) {
						...
						"ajax": "<?php echo URL;?>ubitech/trialgetOrganizationData?conttype="+conttype+"&date="+range,
						"columns": 
						[
							{ "data": "change"},
							{ "data": "orgName"},
