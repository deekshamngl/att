...
class Att_services_Copy_8232019 extends CI_Controller{
	function __construct()
    {
        parent::__construct();
		$this->load->model('Att_services_model_Copy_8232019');
    }
...
/* 	public function reqForTimeOff(){
	...
	public function reqForTimeOff(){
		header('Access-Control-Allow-Origin: *');
		try{		
		$deptarray = $this->Att_services_model_Copy_8232019->Createtimeoff();  
