			...
			<div class="content ">
				...
				<h6 class="nav-tabs-title">Transaction Success </h6>
								...
								<div>
									...
									<p>
										Congratulations! Your payment has been successfully received & you have updated your plan for next <?php echo $plan==12?'one year':'one month'; ?> . Your transaction details are:
									</p>
									<ul>
										<li><b>Name:</b> <?php echo $firstname; ?></li>
										<li><b>Transaction status:</b> <?php echo 'success'; ?></li>
										<li><b>Transaction Id:</b> <?php echo $txnid; ?></li>
										<li><b>Transaction Date & Time:</b> <?php echo date('d-m-Y'); ?></li>
										<li><b>Payment Amount:</b> <?php echo $cur.' '.$amount; ?></li>
